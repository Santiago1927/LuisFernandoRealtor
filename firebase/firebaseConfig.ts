...
const firebaseConfig = {
  apiKey:
    ...
    "AIzaSyA0TbaZphhlB2bYWqoSFUVvbbiUnDt7jjk",
  authDomain:
    process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN ||
    "inmapp-842fa.firebaseapp.com",
  ...
  appId:
    ...
    "1:47451790122:web:ee44b4680617202a12dc53",
  measurementId:
    process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID || "G-2NVB1GTJ99",
};
